          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-primary">Purchase Entry List</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="purchaseentry.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table class="table table-hover">
                      ...
                      <?php
                         ...
                         $sql = " SELECT * FROM purchaseentry ORDER by id desc" ;
                     ...
                     <td><?php echo $rows['payment'];?></td>                          
                          ...
                          <td nowrap>
                          <a href="purchaseentry_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
