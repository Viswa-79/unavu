            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
                ...
                <tbody>
                  <?php
                  $sno=1;
                  $sql4 = " SELECT * FROM order1 s left join order2 s1 on s.id=s1.cid order by ord_no asc";
               ...
               <td><?php echo $wz1['ord_no']; ?></td>      
               <td nowrap><?php echo $wz1['date']; ?></td>      
               <td><?php echo $wz1['pono']; ?></td>      
               <td><?php echo $wz1['partyname']; ?></td>      
...
<a href="sales_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
