...
<body>
 ...
 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['deliverydt'];?></span>
</td>
...
$i=1;
  ...
  <tr style="border-bottom:1px solid black;" >
	...
	{ ?> Item no: <?php echo $b3->code;?> / &nbsp;PO No.:<?php } ?>
	  <?php 
	  if($b3->pono!='' && $b3->pono!='-'){
	  echo $b3->pono; }?></strong></br><strong>Description :</strong><?php echo $b3->itemdesc;?></br>
