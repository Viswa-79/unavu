...
<title>Sales Invoice Print 3</title>
<style>
table {
...
$a1="SELECT * FROM partymaster where id='$accountname'";

$a11=mysqli_query($conn,$a1);
$r1=mysqli_fetch_array($a11);
...
$sqrate=round((($b3->amount)/$sqmeters),5);
}
else
{
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px;">
   ...
   border-right: none;vertical-align:top;" align="left"><strong><?php echo $b3->balenos;?></strong></td>
    ...
    <td align="right" height="" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-bottom:none;border-left: 2px solid black; border-collapse: collapse;vertical-align:top;"><br /><strong><?php 
		echo number_format((float)$sqrate, 5, '.', ''); 
	?></strong></td>
...
INV NO: OMT-<?php echo $invoiceno;?>/18-19 DT. <?php echo $date2;?></strong></td>
    ...
    <td height="" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-collapse: collapse;text-align:right;vertical-align:top;"><strong><?php echo number_format((float)$latepayment, 2, '.', '');?></strong></td>
  </tr>
	  	  <?php
		  }
...
{	  
 ...
 <tr style="">
    ...
    <td height="" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-collapse: collapse;"></td>
  	 ...
  	 <tr style="">
    <td height="18" style="border-left: 2px solid black;border-top:none;border-bottom:none;border-right: none;border-collapse: collapse;border-collapse: collapse;"></td>
    <td style="border-left: none;border-top:none;border-bottom:none;border-right: 2px solid black;border-collapse: collapse;border-collapse: collapse;"><strong>GR.WT:<?php echo number_format((float)$grwt, 3, '.', ''); 
	?> KGS</strong></td>
...
<?php $ttt=number_format((float)($tty-$disamt+$packing+$latepayment+$othercharges), 2, '.', '');
?>
...
<?php /*?>  <tr >
  ...
  <tr>
	...
	<div  style="margin-left:20%;"><strong>DRAWBACK FILLING</br>
	HSCODE:<?php echo $hsncode;?></br>
