            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
                ...
                <tbody>
                  <?php 
                 $sno=1;
                 $sql4 = " SELECT * FROM stockinward s left join stockinward1 s1 on s.id=s1.cid order by receipt asc";
               ...
               <td style="text-align:right"><?php echo $wz1['gstno']; ?></td>      
...
<a href="stock_inward_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
