...
<html
 ...
 <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >Stitching List</h5>
               ...
               &nbsp;  <a class="btn btn-primary add-new " tabindex="0" href="stitching.php"
                 type="button" >
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,s.id as id FROM stitching s left join staff sm on s.tostitch=sm.id ORDER by s.id desc" ;
...
if(data.sts == 'ok'){
  ...
  window.location='stitchinglist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delstitching.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
