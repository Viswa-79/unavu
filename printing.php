...
if (isset($_POST['submit'])) {
  ...
  if ($date != '') {
$sql = "INSERT into printing (book,date,deliverydt,orderno,checking,reorder,to1,flref,instruction,remarks,label,label1) 
 values ('$book','$date','$deliverydt','$orderno','$checking','$reorder','$to1','$flref','$instruction','$remarks','$p1','$p2')";
    $result = mysqli_query($conn, $sql);
  }
