...
<html
 ...
 <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >Sample List</h5>
               ...
               &nbsp;  <a class="btn btn-primary add-new " tabindex="0" href="sample.php"
                 type="button" >
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM sample e left join partymaster p on e.partyname=p.id ORDER by e.id desc" ;
...
if(data.sts == 'ok'){
  ...
  window.location='samplelist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delsample.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
