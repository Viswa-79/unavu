            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
                ...
                <tbody>
                  <?php 
                 $sno=1;
                 $sql4 = " SELECT * FROM stockoutward s left join stockoutward1 s1 on s.id=s1.id order by delno asc";
               ...
               <td><?php echo $wz1['delno']; ?></td>      
               <td><?php echo $wz1['staff']; ?></td>      
...
<a href="stock_out_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
