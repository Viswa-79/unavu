...
$result1=mysqli_query($conn, $sql);
 ...
 echo $sql="UPDATE gsm SET gsm='$gsm' WHERE id='$id'"; 
  $result2=mysqli_query($conn, $sql);

}
if($result1) { 
  echo "<script>alert('GSM Registered Successfully');window.location='product_gsm.php';</script>";
}
else if($result2) { 
  echo "<script>alert('GSM Updated Successfully');window.location='product_gsm.php';</script>";
