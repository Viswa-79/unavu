              ...
              <div class="card mb-2 mt-2" >
                <form class="card-body"action="" method="post" enctype="multipart/form-data">
                    ...
                    <?php } ?>                                        
                        ...
                        <div class="row g-3">
                          <div class="col-md-4">
                            <label class="form-label" for="collapsible-fullname">Sales&nbsp;Order&nbsp;No</label>
                            <input
                              type="text"
                              id="orderno"
                              name="orderno"
                         ...
                         <!-- <div class="col-4">
                            ...
                            <select name="delivery" id="delivery" class="select2 form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
                    ...
                    while($rw = mysqli_fetch_array($result))
					{ ?>
                     <option <?php if($rw['id']==$wz1['delivery']){ ?> Selected <?php } ?> value="<?php echo $rw['id'];?>"><?php echo $rw['name'];?></option>
                    <?php } ?>                                        
...
<input type="text" hidden class="form-control form-control-lg" name="rc[]" id="rc" value="<?php echo $i;?>">
              ...
              <div class="row g-3 mt-2">
                          ...
                          <a class="btn btn-label-secondary btn-prev" href="purchaseorderlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $remarks = $_POST['remarks'];
   ...
   $sql = "UPDATE purchaseorder SET purchaseno='$purchaseno',date='$date',supplier='$supplier',material='$material',payment='$payment',orderno='$orderno',orderref='$orderref',orderqty='$orderqty',delivery='$delivery',taxable='$taxable',cgst='$cgst',sgst='$sgst',igst='$igst',round='$round',net='$net',remarks='$remarks' where id='$cid'";
    $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['specification'] as $key => $val) {
    ...
    if ($specification != '') {
     $sql1 = "UPDATE purchaseorder1 SET productname='$productname',specification='$specification',color='$color',dia='$dia',bags='$bags',quantity='$quantity',unit='$unit',unit='$unit',rate='$rate',amount='$amount' where id='$rid'";
