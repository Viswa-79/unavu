          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-primary">Stock Inward List</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="stockinward.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table class="table table-hover">
                      ...
                      <?php
                         ...
                         $sql = " SELECT *,s.id as id FROM stockinward s left join partymaster p on s.supplier=p.id ORDER by s.id desc" ;
                     ...
                     <td><?php echo $rows['name'];?></td>                          
                          ...
                          <td nowrap>
                          <a href="stockinward_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          type="button" style="width:113px" class="btn btn-outline-warning" id="edit<?php echo $sno;?>">
                            ...
                            <a  href="ajax/delstockinward.php?cid=<?php echo base64_encode($rows['id']);?>"
                             type="button" data-bs-toggle="offcanvas"
                          data-bs-target="#offcanvasEcommerceCustomer"style="width:113px" 
                          class="btn btn-outline-danger"
                          id="del<?php echo $sno;?>" 
                          onclick="delstockinward(del<?php echo $sno;?>.id);" >
...
if(data.sts == 'ok'){
  ...
  window.location='stockinwardlist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delstockinward.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
