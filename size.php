            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >SIZE LIST</h5>
               ...
               &nbsp;   <button class="btn btn-secondary add-new btn-primary" tabindex="0" onclick="addSize();" aria-controls="DataTables_Table_0"
                ...
                <span class="d-none d-sm-inline-block">Add New Size</span></span></button>
                      </div>
                    </div>
...
if(isset($_POST['submit']))
{
  ...
  if($result1) { 
    echo "<script>alert('Size Saved Successfully');window.location='size.php';</script>";
  }
  else if($result2) { 
    echo "<script>alert('Size Updated Successfully');window.location='size.php';</script>";
...
if(data.sts == 'ok'){
    ...
    xmlhttp.open("GET","ajax/getSize.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>
...
if(data.sts == 'ok'){
  ...
  window.location='size.php';
    ...
    xmlhttp.open("GET","ajax/delSize.php?id="+user_id,true);
    xmlhttp.send();
  }
}
}
