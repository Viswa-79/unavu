          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-primary">Purchase Order List</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="purchaseorder.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table class="table table-hover">
                     ...
                     <td><?php echo $rows['payment'];?></td>                          
                          ...
                          <td nowrap>
                          <a href="purchaseorder_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          type="button" style="width:113px" class="btn btn-outline-warning" >
                            ...
                            <a  href="ajax/delpurchaseorder.php?cid=<?php echo base64_encode($rows['id']);?>"
