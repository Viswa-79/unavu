...
<?php
	...
	$sid=base64_decode($_GET['cid']);
		...
		if($sid=='')
{
$s1="SELECT * FROM order order by id desc";
...
?>
  <tr style="border:none;">
   <td  width="709" height="25" style="border:none;"><div style="float:left"></div></td>
    <td  width="709" height="25" style="border:none;"><div style="margin-left:0%"><strong style="font-size:22px;">PURCHASE ORDER</strong></div></td>
...
$wz=mysqli_query($conn,"select * from purchaseorder s left join partymaster p on s.supplier=p.id where s.id='$sid'");
$wz1=mysqli_fetch_array($wz);
$invoiceno=$wz1['purchaseno'];
$paymenttype=$wz1['payment'];
$partyname=$wz1['supplier'];
$delivery=$wz1['delivery'];
...
<table width="850" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center">
  ...
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td  colspan="2"  align="center"  style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black;border-collapse: collapse; border-top: 2px solid black;border-right: 2px solid black;border-collapse: collapse; vertical-align:text-top;" >
   <?php
...
<?php ?>
        <strong style="font-size:20px;"><?php echo $rz2['companyname']; ?></strong><br /><?php ?>
 ...
 <strong>Email : <?php echo $rz2['emailid'];?></strong>
    ...
    <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td width="419" height="38" style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black; border-bottom: 1px solid #999;border-collapse: collapse; border-top: 2px solid black;border-collapse: collapse;font-size:20px;" ><strong>&nbsp;Order No : <?php echo $invoiceno;?></strong>	</td>
	  <td height="38"  style="border: 1px solid thin black;border-collapse: collapse; border-color:#999;border-top: 2px solid black;border-collapse: collapse;border-right:2px solid black;"><strong style="font-size:20px;padding-left:5px;">Order Date : <?php echo $invoicedate;?></strong></td>
	</tr>
	
	
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td height="100"   style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black;border-collapse: collapse; border-top: 1px solid #999;border-bottom: 1px solid #999;border-collapse: collapse; vertical-align:text-top;" >
...
<div style="margin-left:1%;text-transform:uppercase;">
<?php echo $b1['name'];echo ","."<br />";echo $b1['address'];echo "<br />";echo $b1['state'];echo "<br />";echo $b1['country'];?>.<br>
    ...
    <td width="419" height="28"  style="border: 1px solid thin black;border-collapse: collapse;border-color:#999;border-right:2px solid black;padding-left:5px;vertical-align:top;">
...
<?php } ?>
  ...
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
     <td height=""  style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black;border-collapse: collapse; border-top: 2px solid black;border-collapse: collapse;border-top: 1px solid #999;" ><strong>&nbsp;GST No. : 
&nbsp;&nbsp; <?php
   if($b1['gstno']!='')
   {
	   echo $b1['gstno'];
  ...
  <td height="33"  style="border: 1px solid black;border-collapse: collapse;border-color:#999;border-right:2px solid black;padding-left:5px;" >Order Ref : <?php echo $order_ref;?></td>
  </tr>
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  <tr align="center" style="font-weight:bold;border-collapse: collapse;background-color:#<?php echo $color;?>;color:#<?php echo $font_color;?>;">
    <td style="border-left: 2px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-collapse: collapse; " width="46" height="35">Sno</td>
    <td width="207" style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse; border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999;">Particulars</td>
	<td width="102" style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Color</td>
	<td width="54" style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Dia</td>
 
    <td width="75" style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">No. of Bags/Rolls</td>
    <td width="66"  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Qty</td>
   
    <td width="82"  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Unit</td>
	<td width="74"  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid #999;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Rate/Unit</td>
	<td width="102"  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 2px solid black;border-bottom: 1px solid #999;border-left: 1px solid #999; ">Amount</td>
  </tr>
  <?php

		   $sno=1;$i=0;$j=0;
				   	$sql = "SELECT *,s1.specification as specification FROM purchaseorder1 s1 left join  color c on s1.color=c.id left join dia d on s1.dia=d.id  where cid='$sid'";
...
while($row = mysqli_fetch_array($result))
{
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px;">
   ...
   border-right: 1px solid #999;"><div align="center"><?php echo $sno;?> </div></td>
    <td height="" align="left" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse; padding-left:5px;"><strong><?php echo $row['productname'];?><?php if($row['specification']!=''){ echo "<br>";echo $row['specification']; } ?></td>
  ...
  <td height="" align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['unit']; ?> </td>
...
$a1=mysqli_query($conn,"SELECT * FROM purchaseorder where id='$sid'");
...
<table width="850" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center"> 
  ...
  <tr >
    ...
    <td width="386" height="80"  align="center"  style="vertical-align:text-top;border: 1px solid black;border-collapse: collapse; border-color:#999;border-right: 2px solid black;border-collapse: collapse;border-bottom: 2px solid black;border-collapse: collapse;"><strong></strong>
    <div align="left"> 
    <strong>Authorized Signatory</strong></div>
