            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >COLOR LIST</h5>
               ...
               &nbsp;   <button class="btn btn-secondary add-new btn-primary" tabindex="0" onclick="addColor();" aria-controls="DataTables_Table_0"
                 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser"><span>
                  <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                <span class="d-none d-sm-inline-block">Add New Color</span></span></button>
                      </div>
                    </div>
                  ...
                  ?>
                     <input type="text" hidden name="id[]" id="id<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                      ...
                      <td><?php echo $rows['color'];?></td>
                          ...
                          id="edit<?php echo $sno;?>" onclick="getColor(edit<?php echo $sno;?>.id);" 
                         >
                          ...
                          id="del<?php echo $sno;?>" onclick="delColor(del<?php echo $sno;?>.id);" >
               ...
               <tr><td colspan="5" align="center">  <p>No Data Found</p></td> </tr>
                ...
                <div
                  ...
                  <div class="offcanvas-header">
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title"><span id="form-title">Add</span> Color</h5>
                    <button
                      type="button"
...
$result1=mysqli_query($conn, $sql);
 ...
 echo $sql="UPDATE color SET color='$color' WHERE id='$id'"; 
  $result2=mysqli_query($conn, $sql);

}
if($result1) { 
  echo "<script>alert('Color Registered Successfully');window.location='product_color.php';</script>";
}
else if($result2) { 
  echo "<script>alert('Color Updated Successfully');window.location='product_color.php';</script>";
...
function getColor(id) {
  ...
  if (id != "") {
   ...
   $('#color').val(data.color);             
    ...
    xmlhttp.open("GET","ajax/getColor.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>
...
if(data.sts == 'ok'){
  ...
  window.location='product_color.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delColor.php?id="+user_id,true);
    xmlhttp.send();
  }
}
}
