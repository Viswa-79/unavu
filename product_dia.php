            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >DIA LIST</h5>
               ...
               &nbsp;   <button class="btn btn-secondary add-new btn-primary" tabindex="0" onclick="adddia();" aria-controls="DataTables_Table_0"
                 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser"><span>
                  <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                <span class="d-none d-sm-inline-block">Add New Dia</span></span></button>
                      </div>
                    </div>
...
?>
                ...
                <div
                  ...
                  <div class="offcanvas-header">
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title"><span id="form-title">Add</span> Dia</h5>
                    <button
                      type="button"
                  ...
                  <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                    <form action="" method="post">
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Dia</label>
                        <input
                          type="text"
                          class="form-control"
                          id="dia"
...
$result1=mysqli_query($conn, $sql);
 ...
 echo $sql="UPDATE dia SET dia='$dia' WHERE id='$id'"; 
  $result2=mysqli_query($conn, $sql);

}
if($result1) { 
  echo "<script>alert('Dia Registered Successfully');window.location='product_dia.php';</script>";
}
else if($result2) { 
  echo "<script>alert('Dia Updated Successfully');window.location='product_dia.php';</script>";
...
function getdia(id) {
  ...
  if (id != "") {
   ...
   $('#dia').val(data.dia);             
    ...
    xmlhttp.open("GET","ajax/getdia.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>
...
if(data.sts == 'ok'){
  ...
  window.location='product_dia.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/deldia.php?id="+user_id,true);
    xmlhttp.send();
  }
}
}
