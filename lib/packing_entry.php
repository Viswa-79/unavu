...
$('#cartonsize'+c).val(data.cartoon);
}

      }
    };
    xmlhttp.open("GET","ajax/get_cartoon.php?id="+value,true);
    xmlhttp.send();
  }
}
</script>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <td style="padding: 0.3rem">
                               <select name="itemno[]"    style="width:150px" id="itemno<?php echo $i;?>" class="select form-select" onchange="get_quality(this.id,this.value);get_item_details(this.id,this.value);get_tot(this.id,this.value);get_cartoon(this.id,this.value);" >
              ...
              <td style="padding: 0.3rem">
                ...
                <td style="padding: 0.3rem">
                               <select name="itemno[]"    style="width:150px" id="itemno<?php echo $i;?>" class="select form-select" onchange="get_quality(this.id,this.value);get_tot(this.id,this.value);get_cartoon(this.id,this.value); ">
                                <option value="">Select</option>
