            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div  class="card mb-4 ">
               ...
               <tbody>
                ...
                $sql4 = " SELECT *,s1.orderno as orderno,s1.descr as descr FROM checking_inward s left join checking_inward1 s1 on s.id=s1.cid left join item_master m on s1.itemno=m.id left join partymaster k on s.partyname=k.id left join color j on s1.color=j.id where date between '$fromdate' and '$todate' and s1.orderno='$orderno' and itemno='$itemno' ORDER BY s1.orderno asc";
                $result4 = mysqli_query($conn, $sql4);
                while($wz1 = mysqli_fetch_array($result4)){
            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div  class="card mb-4 ">
               ...
               <tbody>
                ...
                $sql4 = " SELECT *,s1.orderno as orderno,s1.descr as descr FROM checking_outward s left join checking_outward1 s1 on s.id=s1.cid left join item_master m on s1.itemno=m.id left join partymaster k on s.partyname=k.id left join color j on s1.color=j.id  where date between '$fromdate' and '$todate' and s1.orderno='$orderno' and itemno='$itemno' ORDER BY s1.orderno asc";
                $result4 = mysqli_query($conn, $sql4);
                while($wz1 = mysqli_fetch_array($result4)){
...
<a href="order_history_report.php" class="btn btn-primary "><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
