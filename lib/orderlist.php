          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">ORDERS&nbsp;LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="order_confirm.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM order1 e left join partymaster p on e.partyname=p.id  WHERE ordertype!='Garments' ORDER by e.ord_no desc" ;
                  ...
                  <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                    ...
                    <td><?php echo substr($rows['name'], 0, 20); ?>..</td>                          
                     ...
                     <td nowrap>
                       <a href="order_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
                       type="button" class="btn btn-outline-warning" id="<?php echo $sno;?>">
                         <span class="ti-xs ti ti-printer me-1"></span>Print
                       </a>

                          <a href="order_confirm_upd.php?cid=<?php echo base64_encode($rows['id']);?>" type="button" class="btn btn-outline-primary" id="edit<?php echo $sno;?>"><span class="ti-xs ti ti-edit me-1"></span>View/Edit
                          </a>
						  
                          <?php if($user_role==2){ ?>
                          <a  href="ajax/delorder.php?cid=<?php echo base64_encode($rows['id']);?>" type="button" data-bs-toggle="offcanvas"
...
if(data.sts == 'ok'){
  ...
  window.location='orderlist.php';
    ...
    xmlhttp.open("GET","ajax/delorder.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
