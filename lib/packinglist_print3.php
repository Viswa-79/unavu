...
<title>Packing List Print 3</title>
<style>
table {
...
if($accountname!="0"){
$a1=mysqli_query($conn,"SELECT * FROM partymaster Where id='$accountname'");
...
$a1=mysqli_query($conn,"SELECT * FROM fa_accountsmaster where sno='$agent'");
...
<div style=" height:40px;vertical-align:top;text-transform:uppercase;font-weight:bold;" align="left">  <?php
 ...
 <tr style="vertical-align:text-top;border: 1px solid black;border-collapse: collapse;border-color:#999;">
  ...
  <tr style="vertical-align:text-top;border: 1px solid black;border-collapse: collapse;border-color:#999;">
    ...
    <strong><?php echo $pname;echo ","."<br />";echo $caddress;echo ","."<br />";/*echo $d1;echo $s1;echo "<br />";echo $v1;echo "<br />";echo $t1;*/ echo $dt1;echo ""."&nbsp;- ";echo $statecode1;echo ","."<br />";echo $state1. "<br />".$country1."."."<br />";?><?php if($eorino!=''){ echo"Eori No&nbsp; : " .$eorino."<br/>" ;}?> <?php if ($vatno!=''){ echo "Vat&nbsp;No&nbsp;&nbsp;&nbsp;: ".$vatno ; }?>
    ...
    <div style="margin-left:0%;text-transform:uppercase;">
   <strong><?php if($accountname!='0'){ echo $pname2;echo ","."<br />";echo $d2; }?>  </strong></div>    </td>
  </tr>
...
<table width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
 ...
 <td style="border: 2px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 2px solid black;border-bottom: 2px solid black;;border-left: 2px solid black;vertical-align:top; " width="59">Quantity</br><strong>
	<?php if($ordertype=='FABRICS'){ ?>SQ.MTRS<?php } else { ?><?php echo $measurement;?><?php } ?></strong></td>
...
<?php $ttt=$tty-$disamt+$packing+$freight;
?>
    <td height="37" colspan="2" align="left" style="border-collapse:collapse; border-top: 2px solid black;border-bottom:none;border-right: 2px solid black;border-left: 2px solid black;" ></br><strong style="text-transform:uppercase;"><?php 
	unset($packing);
