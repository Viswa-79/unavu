...
$party=$so['partyname'];
 $comp=$so['company_name'];

?>


<?php
 $sql1 = " SELECT * FROM address where id='2'";
...
<body>
   ...
   <?php
	...
	?>
	  ...
	  <table width="950"  align="center" style="border-collapse:collapse;border:none;height:1600px;">
  ...
  <table width="950"  align="center" style="border-collapse:collapse; border:none;">
    ...
    <tr height="130px">
      ...
      <?php } ?>
	   ...
	   <table width="950"  align="center" style="border-collapse:collapse; border-bottom:1px solid black;">
...
?>
   ...
   <table width="950"  align="center" style="border:none;margin-top:5px;">
  ...
  <table width="950" align="center" style=" border:1px solid #000000; border-collapse: collapse;">
    <tr>
   
      <td width="380"  style=" border:1px solid #000000; "><div align="center" >
        <strong>Style Code</strong>
      </div></td>
      <td width="20%"  style=" border:1px solid #000000; "><div align="center" >
        <strong>Style Description</strong>
      </div></td>
      <td width="10%"  style=" border:1px solid #000000; "><div align="center" ><strong>Fabric Description</strong></div></td>
      <td width="7%"  style=" border:1px solid #000000; "><div align="center" ><strong>Color</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>XS</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>S</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>M</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>L</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>XL</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>XXL</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center" ><strong>XXXL</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center"><strong>Quantity <?php if($so['ordertype']=='MADEUPS'){ echo "Pcs"; } else {echo "Pcs"; }?> (+/- <?php echo $so['tolerance'];?>%)</strong></div></td>
      <td width="5%"  style=" border:1px solid #000000; "><div align="center"><strong>Price in </br><?php echo $so['currency'];?>&nbsp;<?php echo $so['shipterm'];?></strong></div></td>
	  <td width="5%"  style=" border:1px solid #000000; "><div align="center"><strong>Total <?php echo $so['currency'];?>&nbsp;<?php echo $so['shipterm'];?></strong></div></td>
...
$sql1 = " SELECT *,e.id as id,e.print as print FROM order2 e left join item_master p on e.itemno=p.id left join fabric_master c on e.fabricdesc=c.id left join color b on e.color=b.id WHERE e.cid='$sid'";
$result1 =mysqli_query($conn, $sql1);
while($b3=mysqli_fetch_object($result1))
  ...
  <tr style="border-bottom:1px solid black;" >
      ...
      <td height="21" style="border-right:1px solid black;"> <div align="center" style="margin-left:2%;"><strong>
      <?php if($b3->itemno!='' && $b3->itemno!='-'){ ?></strong> <?php echo $b3->code;echo"</br>"; }?>
	  
	
	</div></td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->itemdesc;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->fabric;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->color;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->xs;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->s;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->m;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->l;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->xl;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->xxl;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->xxxl;?> </div>      </td>
      

      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->quantity;?> <?php echo $b3->unit;?></div>      </td>
    
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->price;?>
  ...
  <tr  style="border:none;">
      ...
      <td height="21" style="border-left:1px solid #FFFFFF;border-bottom:1px solid #FFFFFF;" colspan="7"> <div align="center"> </div></td>
	
      <td  style="border-left:1px solid black;" colspan="3" ><div align="center"><strong>TOTAL PCS</strong></div></td>
	  <td  style="border-left:1px solid black;" ><div align="center"><strong><?php echo $totqty; ?></strong></div></td>
	  <td  style="border-left:1px solid black;" ><div align="center"><strong><?php echo $so['currency'];?></strong></div></td>
  ...
  <table  width="950" align="center" style=" border:none;border-collapse: collapse;">
 <?php
...
$b3=mysqli_fetch_array($result1);
 ...
 <span class="style5"><strong>Accessories</strong> </span>
</td>
<td style="border:none; border-right:none; vertical-align:text-top;" >:</td>
 <td style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5"><?php echo $so['access'];?></span>
</td>
...
<table  width="950" align="center" style=" border-top:1px solid #000000; border-collapse: collapse;margin-top:5px;float:bottom;align:bottom;">
<tr><td></td></tr>
</table>
