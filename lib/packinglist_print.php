...
$a2="SELECT * FROM partymaster where id='$partyname'";

$a2=mysqli_query($conn,$a2);
...
$state1=$r2['state'];
$country1=$r2['country'];
$statecode1=$r2['pincode'];
if($accountname!="0")
{
$a3="SELECT * FROM partymaster where id='$accountname'";
$a=mysqli_query($conn,$a3);
$r2=mysqli_fetch_array($a);
...
//$iecode2=$r2['iecode'];
$state2=$r2['state'];
//$statecode2=$r2['statecode'];

}
/*


$a1=mysqli_query("SELECT * FROM fa_accountsmaster where sno='$agent'");
...
$zz=mysqli_query("select * from address");
...
<div style=" height:40px;vertical-align:top;text-transform:uppercase;font-weight:bold;" align="left">  <?php
 ...
 <tr style="vertical-align:text-top;border: 1px solid black;border-collapse: collapse;border-color:#999;">
	...
	<strong>   TIN NO:<?php echo $rz2['tinno'];?></strong></td>
      <td width="206" style="border-right: 2px solid black;border-collapse: collapse;border-top: 2px solid black;border-left: 1px solid black;border-collapse: collapse;">&nbsp;<strong></br>LUT NO:<?php echo $lutno2;?></strong></td>   
  </tr>
  <tr style="vertical-align:text-top;border: 1px solid black;border-collapse: collapse;border-color:#999;">
    ...
    <strong><?php echo $pname;echo ","."<br />";echo $caddress;echo ","."<br />";/*echo $d1;echo $s1;echo "<br />";echo $v1;echo "<br />";echo $t1;*/ echo $dt1;echo ""."&nbsp;- ";echo $statecode1;echo ","."<br />";echo $state1;echo "<br />".$country1."."."<br />";?><?php if($eorino!=''){ echo"Eori No&nbsp; : " .$eorino."<br/>" ;}?> <?php if ($vatno!=''){ echo "Vat&nbsp;No&nbsp;&nbsp;&nbsp;: ".$vatno ; }?>
    ...
    <div style="margin-left:0%;text-transform:uppercase;">
    <strong><?php if($accountname!='0'){ echo $pname2;echo ","."<br />";/*echo $s2;echo "<br />";echo $v2;echo "<br />";echo $t2; echo $dt2; echo "<br />";*/echo $state2;echo "<br />";echo $d2; }?>
 ...
 <tr style="border: 1px solid black;border-collapse: collapse; border-color:#999;">
	...
	<strong style="text-transform:uppercase;"><?php echo $carriage;?></strong></td>
...
<table width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  <tr align="center" style="border-collapse: collapse;font-size:12px;" height="30">
    ...
    <td style="border-right: 2px solid black;border-top: 2px solid black;border-collapse: collapse; border-bottom: 2px solid black;;border-left: 1px solid #999;vertical-align:top;" width="73" >GROSS WT.</strong></td>
  </tr>
...
?>
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px;">
   ...
   border-right: none;vertical-align:top;" align="left"><strong><?php echo $b3->balenos;?></strong></td>
    <td align="left" height="" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: none; border-collapse: collapse;font-size:12px;text-transform:uppercase;"><strong>Order No. OMT-<?php echo $orderno1;?> DT :<?php echo $date3; ?> Po No : <?php echo $pono;echo "<br>" ?> Item No:<?php echo $b3->code;?> <?php   echo nl2br($b3->itemdesc);?></strong></td>
...
<tr align="center" style="">
    <td height="37" colspan="2" align="left" style="border-collapse:collapse; border-top: 2px solid black;border-bottom:none;border-right: 2px solid black;border-left: 2px solid black;" ></td>
...
<div align="center"><input type="button" value="Print" onClick="PrintElem('#mydiv')" />
	  ...
	  <a href="#.php?cid=<?php echo $sid;?>" >  <input type="button" value="Export To Word" /></a> 
