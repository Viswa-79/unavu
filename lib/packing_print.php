...
$sid=base64_decode($_GET['cid']);
 ...
 $sql = " SELECT *,e.id as id FROM packing e left join staff p on e.to1=p.id WHERE e.id='$sid'";
...
$a11=mysqli_query($conn,"SELECT * FROM packing1 where cid='$sid'");
...
<body>
  ...
  <table width="878"  align="center" style="border-collapse:collapse; border:none;">
   ...
   <table width="878"  align="center" style="border:none;">
    
        <tr >
      <td style="border:none; vertical-align:text-top;" align="left">
	  
	  <strong>To:</strong> <?php echo $ad['companyname'];?> Packing Unit
	  </br></br>
...
$i=1;
    ...
    $b1="SELECT *,e.id as id,e.print as print,e.quality as quality FROM packing1 e left join item_master p on e.itemno=p.id where cid='$sid' order by e.id asc";
  ...
  <tr style="border-bottom:1px solid black;" >
	 ...
	 <?php if($so1->itemno!='' && $so1->itemno!='-' && $so1->visible!='0')
	{ ?> Item No: <?php echo $so1->code;?><?php } ?>/ <?php if($so1->pono!=''){ ?>PO No.:
	<?php 
	  echo $so1->pono; ?><?php } ?></strong>
      </br><strong>Description :</strong>&nbsp;<?php echo $so1->itemdesc;?></br>
	<?php if($so1->print!='' && $so1->print!='-')
	{ ?>  
	<strong><?php if($so1->print!=''){ ?>  Print :</strong>&nbsp;<?php echo $so1->print;
	  }	?><?php }?> </div></td>
      <td  style="border-right:1px solid black;" ><div align="left" style="margin-left:2%;"><strong>Quality :</strong>&nbsp;<?php echo $so1->quality;?></br>
      <?php if($so1->size!='' && $so1->size!='-')
	{ ?>  
	<strong>  Size :</strong>&nbsp;<?php echo $so1->size;
	  }	?> </div></td>

      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $so1->quantity;?> <?php echo $so1->unit;?></div>      </td>
...
<br />
 ...
 <table  width="878" align="center" style=" border:none;border-collapse: collapse;">
  ...
  <tr style="line-height:35px;">
 <td width="272" style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5"><strong>Repeat Order No</strong> </span></td>
 <td width="594" style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['reorder'];?></span></td>
 ...
 <span class="style5"><strong>Packing Instuction</strong> </span></td>
 <td width="594" style="border:none; border-right:none; vertical-align:text-top;" >
 ...
 <span class="style5"><strong>Port of Destination </strong></span></td>
 <td width="594" style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['port'];?></span></td>
 ...
 <span class="style5"><strong>Shipment </strong></span></td>
 <td width="594" style="border:none; border-right:none; vertical-align:text-top;" >
