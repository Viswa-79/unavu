        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM printing_outward WHERE id='$sid'";
                    ...
                    <?php } ?>
                       ...
                       <?php } ?>
                        ...
                        <table class="table table-border border-top table-hover">
                              ...
                              <?php
                                  $sno=1; $i=0;
                              $sql4 = " SELECT * FROM printing_outward1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
              ...
              <td style="padding: 0.3rem">
               <input 
                                  ...
                                  value="<?php echo $rw['printmistake']; ?>"
                                  name="printmistake[]"
...
<?php $sno++; $i++;
            ...
            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-secondary btn-prev" href="printoutlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE printing_outward SET dcno='$dcno',refno='$refno',date='$date',partyname='$partyname',process='$process',vehicleno='$vehicleno',
 dvrname='$dvrname' WHERE id='$cid'";
  ...
  foreach ($_POST['pcs'] as $key => $val) {
   ...
   $sql1 = "UPDATE  printing_outward1 SET cid='$cid',orderno='$orderno',itemno='$itemno',ref='$ref',pcs='$pcs',printmistake='$printmistake',fabmistake='$fabmistake',loss='$loss',descr='$descr' WHERE id='$rid'";
  ...
  echo "<script>alert('Printing Updated Successfully');window.location='printoutlist.php';</script>";
