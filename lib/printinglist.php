          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">PRINTING LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="printing.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                ...
                <div class="card-body">
                  <div class="card-datatable table-responsive">
                   ...
                   <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                     ...
                     <td><?php echo $rows['flref'];?></td>                          
                                      
                                                
                          <td nowrap>
                            <a href="printing_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
...
if(data.sts == 'ok'){
  ...
  window.location='printinglist.php';
