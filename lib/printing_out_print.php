...
<title>Printing Outward Print</title>
<style>
table {
...
<table align="center" width="852" style="border:none; page-break-before:always;">
  ...
  <tr style="border:none;">
    <td  width="709" height="25" style="border:none;"><div style="margin-left:40%"><strong style="font-size:22px;">PRINTING OUTWARD</strong></div></td>
  </tr>
</table>
 ...
 $wz=mysqli_query($conn,"select * from printing_outward e left join process b on e.process=b.id     where e.id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['refno'];
$date=$wz1['date'];
$dcno=$wz1['dcno'];
...
<table width="850" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center">
 ...
 <strong>Email : <?php echo $rz2['emailid'];?></strong>
    ...
    <td height="38" colspan="2" style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black; border-bottom: 1px solid #999;border-collapse: collapse; border-top: 2px solid black;border-collapse: collapse;" ><strong>&nbsp;Party Name :-</strong>
	  ...
	  <td width="183" height="38" style="border: 1px solid thin black;border-collapse: collapse; border-color:#999;border-top: 2px solid black;border-collapse: collapse;border-right:none;"><strong style="font-size:20px;padding-left:5px;">Dc No</strong><strong style="font-size:20px;"></strong></td>
...
<div style="margin-left:15%;margin-top:2%">
        <?php  
          $a0="SELECT * FROM printing_outward e left join partymaster a on e.partyname=a.id  where e.id='$sid'";
//echo $a0;
...
<br /><br />
  ...
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td height="33" style="border: 1px solid black;border-collapse: collapse;border-color:#999;border-right:none;padding-left:5px;" ><strong>Ref No</strong></td>
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  <tr align="center" style="font-weight:bold;border-collapse: collapse;background-color:#<?php echo $color;?>;color:#<?php echo $font_color;?>;">
    ...
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Printing Mistake[Pcs]</td>
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Fabric Mistake[Pcs]</td>
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Pieces</td>
    <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 2px solid black;border-bottom: 2px solid black ;border-left: 1px solid black; ">Loss Qty</td>

</tr>
  <?php

		   $sno=1;$i=0;$j=0;
 $sql = "SELECT *,j.descr as descr  FROM printing_outward1 j    left join item_master z on j.itemno=z.id where j.cid='$sid' order by j.id asc";
...
while($row = mysqli_fetch_array($result))
{
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px;">
   ...
   border-right: 1px solid #999;"><div align="center"><?php echo $sno;?> </div></td>
    ...
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['printmistake']; ?></td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['fabmistake']; ?></td>
    ...
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['loss']; ?></td>
  </tr>
  <?php
	
  $tlpcs+=number_format((float)$row['pcs'], 2, '.', '');
  $toloss+=number_format((float)$row['loss'], 2, '.', '');
...
<td  style="border-right:2px solid black;" ><div align="right"><strong><?php echo $toloss; ?></strong></div></td>
</tr>
