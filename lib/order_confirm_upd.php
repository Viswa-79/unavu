...
function get_qty(id,value) {
  ...
  // alert(value);
  var value2=document.getElementById('ordertype').value;
...
xmlhttp.open("GET","ajax/getenqitem2.php?id="+value+"&q2="+value2,true);
xmlhttp.send();
  }
}
</script>
...
var v=document.getElementById('price'+b).value?document.getElementById('price'+b).value:0;
	...
	document.getElementById('totamt'+b).value=tt.toFixed(2);
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                ...
                <div class="card-header d-flex align-items-center justify-content-between">
                      <button  class="btn btn-label-primary">Order Confirmation</button>
                      <a href="orderlist.php"
                          type="button" class="btn btn-outline-warning" >
                            <span class="ti-xs ti ti-eye me-1"></span>View Orders
                          </a>
                    </div><br>
                    ...
                    $row = mysqli_fetch_array($result);
                      ...
                      ?>
                        ...
                        <input type="text" hidden name="cid" id="cid" value="<?php echo $row['id'];?>">                                                                                                                                                                                                                                                  <tr>
                          ...
                          <div class="col-md-2">
                            <label class="form-label" for="collapsible-fullname">Order No&nbsp;<span style="background-color: blueviolet; color: white;border-radius: 2px;padding: 2px"> OMT </span>&nbsp;<span style="color:red;">*</span></label>
                            <input
                              type="text"
                              id="ord_no"
                              name="ord_no"
                          ...
                          <div class="col-md-3">
                            ...
                            <select name="ordertype" id="ordertype"
                               class="select form-select" data-allow-clear="true">
                                ...
                                <option value="Fabrics" <?php if($row['ordertype']=='Fabrics'){ ?>Selected<?php } ?> >Fabrics </option>
                                <option value="Madeups" <?php if($row['ordertype']=='Madeups'){ ?>Selected<?php } ?> >Madeups</option>                                
                ...
                <option value="Box">Yes</option>
                 <option value="Box">No</option>
                    ...
                    <?php } ?>                                        
                        ...
                        <input src="upload_images/<?php echo $wz1['doc1']; ?>"
class="form-control" type="file" id="file1" name="doc1" 
  ...
  <?php if ($wz1['doc1']!='') {
    ...
    <?php } ?>                   
                        ...
                        <input class="form-control" src="upload_images/<?php echo $wz1['doc2']; ?>" type="file" id="file2" name="doc2" 
  ...
  <a href="uploads/<?php echo $wz1['doc2']; ?>" target="blank"><?php echo $wz1['doc2']; ?></a>                     
                        ...
                        <input  src="upload_images/<?php echo $wz1['doc3']; ?>" class="form-control" type="file" id="file3" name="doc3"
  ...
  <a href="uploads/<?php echo $wz1['doc3']; ?>" target="blank"><?php echo $wz1['doc3']; ?></a>                     
                        ...
                        <input src="upload_images/<?php echo $wz1['doc4']; ?>" class="form-control" type="file" id="file4" name="doc4" 
...
<div class="table-responsive">
                 ...
                 <input style="width:120px"
                                   ...
                                   <td style="padding: 0.3rem">
                                   <select name="itemno[]" style="width:300px" id="itemno<?php echo $i;?>" onchange="get_qty(this.id,this.value);" onblur="get_qty(this.id,this.value);" class="select form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
                ...
                <td style="padding: 0.3rem">
                 ...
                 <input
                                    ...
                                    id="price<?php echo $i;?>"
                                    name="price[]"
                                    onkeyUp="tott(quantity<?php echo $i;?>.id);"
                                    onchange="tott(quantity<?php echo $i;?>.id);"
                 ...
                 <input
                                    ...
                                    onkeyUp="tott(this.id,this.value);"
									                 onchange="tott(this.id,this.value);"
                                    name="quantity[]"
                ...
                <td> <a href="ajax/del_orderconfirm1.php?cid=<?php echo base64_encode($rw['id']);?>"><button type="button" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><i class="fa fa-trash"></i></button></a></td>
                          </tr>                            
                                <?php
                            $sno++; $i++;
    }
...
<br>
<button   class="btn btn-label-primary">Shipping Details</button>
<br>
<br>
<div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="input-group">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-dark btn-prev" href="orderlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $inspection = $_POST['inspection'];
    ...
    $sql1 = "UPDATE order1 SET ord_no='$ord_no',enq_no='$enq_no',refno='$refno',date='$date',partyname='$partyname',ordertype='$ordertype',length='$length',
  ...
  foreach ($_POST['pono'] as $key => $val) {
   ...
   if($ostatus=='on'){
    ...
    if ($itemno != '') {
    if ($rid != '') {
       $sql2 = "UPDATE order2 SET pono='$pono',itemno='$itemno',itemdesc='$itemdesc',label='$label',print='$print',quality='$quality',
      ...
      $sql1 = "INSERT into order2 (cid,pono,itemno,itemdesc,label,print,quality,pack,clwidth,size,quantity,unit,price,totamt) 
      values ('$cid','$pono','$itemno','$itemdesc','$label','$print','$quality','$pack','$clwidth','$size','$quantity','$unit','$price','$totamt')";
           $result1 = mysqli_query($conn, $sql1);
    }
  }
  }
...
$p4=$_REQUEST['doc44'];
  ...
  if ($result) {
    ...
    echo "<script>alert('Order Updated successfully');window.location='orderlist.php';</script>";
