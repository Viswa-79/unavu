...
?> </h5>
                ...
                <table  id="ConvertTable" style="width:100%" class=" table table-bordered " style="border-collapse:collapse" border="1" >
                <thead >
                ...
                <tbody>
                 ...
                 { 
                  ...
                  $sql4 = " SELECT * FROM order1 s left join order2 s1 on s.id=s1.cid left join item_master m on s1.itemno=m.id where date between '$fromdate' and '$todate' $rr group by ord_no,itemno order by ord_no,itemno asc";
                ...
                $wz4 = mysqli_fetch_array($result1);
                 ...
                 $sql5 = " SELECT *,sum(totalpcs) as totalpcs FROM packing_entry s left join packing_entry1 s1 on s.id=s1.cid  where date between '$fromdate' and '$todate' and s1.orderno='$orderno' and itemno='$itemno' order by dcno asc";
