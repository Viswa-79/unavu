        ...
        <div class="layout-page">
		 ...
		 ?>
                      <form class="card-body" action="" method="post" enctype="multipart/form-data">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM fabric_process WHERE id='$sid'";
                    ...
                    <?php } ?>
                        ...
                        <table class="table table-border  table-hover">
                            <thead class="border-bottom">
                              ...
                              <?php
                        $sno=1; $i=0;
                              $sql4 = " SELECT * FROM fabric_process1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
                ...
                <td style="padding: 0.3rem">
                                   <select name="itemno[]" style="width:150px" id="itemno<?php echo $i;?>" onchange="get_item_details(this.id,this.value);" class="select form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
                ...
                <select name="fabqty[]" style="width:200px" id="fabqty<?php echo $i;?>"  class="select form-select" data-allow-clear="true">
                                <option value="">Select</option>
							<?php 
                    ...
                    while($rw1 = mysqli_fetch_array($result))
					{ ?>
                     <option <?php if($rw1['id']==$rw['fabqty']){ ?> Selected <?php } ?> value="<?php echo $rw1['id'];?>"><?php echo $rw1['quality'];?></option>
                    <?php } ?>
...
?>
            ...
            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-secondary btn-prev" href="fabric_processlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE fabric_process SET book='$book',date='$date',ref='$ref',follow='$follow',deliverydt='$deliverydt',orderno='$orderno',
 checking='$checking',reorder='$reorder',instruction='$instruction',remarks='$remarks',prepared='$prepared' WHERE id='$cid'";
  ...
  foreach ($_POST['quality'] as $key => $val) {
   ...
   $sql1 = "UPDATE  fabric_process1 SET cid='$cid',orderno='$orderno',quality='$quality',pono='$pono',itemno='$itemno',process='$process',itemdesc='$itemdesc',print='$print',size='$size',quantity='$quantity',unit='$unit',fabqty='$fabqty',fabwidth='$fabwidth',loss='$loss' WHERE id='$rid'";
    $result1 = mysqli_query($conn, $sql1);
  ...
  echo "<script>alert('Fabric Updated successfully');window.location='fabric_processlist.php';</script>";
