...
To: <?php echo date('d/m/Y',strtotime($_REQUEST['todate']));?></h5>
                ...
                <thead >
                  ...
                  <th>S.B No</th>
                    ...
                    <th>Realised Value in Currency</th>
                    <th>Realised Value in INR</th>
  ...
  { 
   ...
   $rr='';  
                 ...
                 $sql4 = " SELECT * FROM salesinvoice where date between '$fromdate' and '$todate' $rr order by invoiceno asc";
               ...
               <td><?php echo $wz1['realizationno']; ?></td>      
               <td><?php echo $wz1['realizationdate']; ?></td>      
               <td><?php echo $wz1['realisedvaluecurrency'];; ?></td>      
               <td><?php echo $wz1['realisedvalueinr']; ?></td>      
...
<a href="brc_rep.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
