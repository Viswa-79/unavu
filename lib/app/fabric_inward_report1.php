 ...
 ?>
            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
               ...
               <td><a href="fabric_inward_upd.php?cid=<?php echo base64_encode($id);?>" target="blank" ><?php echo $wz1['refno']; ?></a></td>      
...
<a href="fabric_inward_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
