...
<title>Cutting Inward Print</title>
<style>
table {
...
<table align="center" width="852" style="border:none; page-break-before:always;">
  ...
  <tr style="border:none;">
    <td  width="709" height="25" style="border:none;"><div style="margin-left:40%"><strong style="font-size:22px;">CUTTING INWARD</strong></div></td>
  </tr>
</table>
 ...
 $wz=mysqli_query($conn,"select * from cutting_inward  where id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['refno'];
$date=$wz1['date'];
$dcno=$wz1['dcno'];
...
<div style="margin-left:15%;margin-top:2%">
        <?php  
          $a0="SELECT * FROM cutting_inward e left join partymaster a on e.partyname=a.id  where e.id='$sid'";
//echo $a0;
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  <tr align="center" style="font-weight:bold;border-collapse: collapse;background-color:#<?php echo $color;?>;color:#<?php echo $font_color;?>;">
    ...
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Item No</td>
  ...
  <?php
		   ...
		   $sno=1;$i=0;$j=0;
$sql = "SELECT *,j.descr as descr,l.color as color,j.width as width,k.quality as quality  FROM cutting_inward1 j  left join quality_master k on j.quality=k.id left join color l on j.color=l.id  left join item_master z on j.itemno=z.id where j.cid='$sid' order by j.id asc";
...
while($row = mysqli_fetch_array($result))
{
  ...
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px;">
   ...
   border-right: 1px solid #999;"><div align="center"><?php echo $sno;?> </div></td>
    ...
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['width']; ?></td>
    ...
    <td height=""  align="left" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['bale']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['bundle']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['pcs']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-left: 1px solid #999; border-collapse: 2px solid black;border-bottom: collapse;padding-right:5px;"><?php echo $row['mtrs']; ?></td>
  </tr>
  <?php
