          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-label-primary">BRC Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="brc_rep1.php" method="post" enctype="multipart/form-data">
					...
					<?php } ?>
                          ...
                          <div class="col-md-3">
                            <label class="form-label" for="collapsible-fullname">Report&nbsp;Type<span style="color:red;">*</span></label>
