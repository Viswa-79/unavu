...
;?> </h5>
             ...
             $sql4 = " SELECT *,w.size as size,w.print as print,q.id as idn,w.quality as quality FROM enquiry q left join enquiry1 w on q.id=w.cid left join partymaster e on q.partyname=e.id left join currency r on q.currency=r.id left join item_master t on w.itemno=t.id where date between '$fromdate' and '$todate' $rr order by q.id asc";
            ...
            ?>
               ...
               <td ><div style="width:150px;"><?php echo $wz1['partyref']; ?></div></td>    
               ...
               <td><div style="width:250px;"><?php echo $wz1['itemdesc']; ?></div></td>      
               <td><?php echo $wz1['quality']; ?></td> 
				<td><?php echo $wz1['print']; ?></td> 			   
               <td><div style="width:250px;"><?php echo $wz1['size']; ?></div></td>      
               <td><?php echo $wz1['quantity']; ?></td>          
               <td><?php echo $wz1['unit']; ?></td>          
               <td><?php echo $wz1['price']; ?></td>          
...
<button onclick="PrintElem('#mydiv')" class="btn btn-secondary" value="Print"><i class="ti ti-printer me-sm-1 me-0"></i>Print</button>&nbsp;&nbsp;
