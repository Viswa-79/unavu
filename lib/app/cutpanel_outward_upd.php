        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM cutpanel_outward WHERE id='$sid'";
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="process" id="process"  class="select form-select" onchange="get_details(this.value)" >
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM process where id IN('4','5') order by process asc";
                    ...
                    <?php } ?>
                         ...
                         <div class="col-md-2">
                            ...
                            <select name="partyname" id="partyname"  class="select form-select" >
                                <option value="">Select</option>
							<?php 
					$sql = "SELECT * FROM partymaster where process ='$process' order by name asc";
                    $result = mysqli_query($conn, $sql);
                    while($rw1 = mysqli_fetch_array($result))
					{ ?>
                    ...
                    <?php } ?>
                        ...
                        <table class="table table-border border-top table-hover">
                              ...
                              <?php
                                  $sno=1; $i=0;
                              $sql4 = " SELECT * FROM cutpanel_outward1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
...
<?php $sno++; $i++;
            ...
            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-dark btn-prev" href="cutpaneloutlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE cutpanel_outward SET dcno='$dcno',refno='$refno',date='$date',partyname='$partyname',vehicleno='$vehicleno',process='$process',
 dvrname='$dvrname' WHERE id='$cid'";
  ...
  foreach ($_POST['quality'] as $key => $val) {
   ...
   $sql1 = "UPDATE  cutpanel_outward1 SET cid='$cid',orderno='$orderno',itemno='$itemno',ref='$ref',quality='$quality',color='$color',pcs='$pcs',descr='$descr',totcut='$totcut',balqty='$balqty'  WHERE id='$rid'";
  ...
  echo "<script>alert('Cut Panel Outward Updated Successfully');window.location='cutpaneloutlist.php';</script>";
