...
<title>Cutpanel Outward Print</title>
<style>
table {
...
<table align="center" width="852" style="border:none; page-break-before:always;">
  ...
  <tr style="border:none;">
    <td  width="709" height="25" style="border:none;"><div style="margin-left:40%"><strong style="font-size:22px;">CUTPANEL OUTWARD</strong></div></td>
  </tr>
</table>
 ...
 $wz=mysqli_query($conn,"select * from cutpanel_outward e left join process b on e.process=b.id     where e.id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['refno'];
$date=$wz1['date'];
$dcno=$wz1['dcno'];
...
<div style="margin-left:15%;margin-top:2%">
        <?php  
          $a0="SELECT * FROM cutpanel_outward e left join partymaster a on e.partyname=a.id  where e.id='$sid'";
//echo $a0;
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  ...
  <?php
		   ...
		   $sno=1;$i=0;$j=0;
 $sql = "SELECT *,j.descr as descr,l.color as color,k.quality as quality  FROM cutpanel_outward1 j  left join quality_master k on j.quality=k.id left join color l on j.color=l.id  left join item_master z on j.itemno=z.id where j.cid='$sid' order by j.id asc";
