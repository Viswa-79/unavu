<?php include "config.php"; ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">FABRIC STOCK LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="fabric_stock.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
 ...
 <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT * FROM fabric_stock ORDER by id desc" ;
                  ...
                  $sql2 = "SELECT * FROM fabric_stock1 where cid='$cid' order by orderno asc" ;
...
if(data.sts == 'ok'){
  ...
  window.location='fabric_stock_list.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delfab_stock.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
