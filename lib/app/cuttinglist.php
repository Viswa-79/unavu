          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">Cutting List</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="cutting.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT * FROM cutting ORDER by id desc" ;
                     ...
                     <td><?php echo $rows['orderno'];?></td>                          
                          ...
                          <td nowrap>
                            <a href="cutting_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <a href="cutting_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <?php if($user_role==2){ ?>
                            <a  href="ajax/delcutting_computation.php?cid=<?php echo base64_encode($rows['id']);?>"
...
if(data.sts == 'ok'){
  ...
  window.location='cuttinglist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delcutting.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
