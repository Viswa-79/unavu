          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-label-primary">Fabric Outward Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="fabric_outward_report1.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php } ?>
                          ...
                          <!-- <div class="col-md-3">
                            ...
                            <input
                              ...
                              id="orderno"
                              name="orderno"
                              onchange="get_items2(this.value);"
                              class="form-control"
                              />
                          </div> -->
                          <div class="col-md-3">
