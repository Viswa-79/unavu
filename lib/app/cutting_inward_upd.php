        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM cutting_inward WHERE id='$sid'";
                    ...
                    <?php } ?>
                        ...
                        <table class="table table-border border-top table-hover">
                              ...
                              <?php
                                  $sno=1; $i=0;
                              $sql4 = " SELECT * FROM cutting_inward1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE cutting_inward SET dcno='$dcno',refno='$refno',date='$date',partyname='$partyname',vehicleno='$vehicleno',
 dvrname='$dvrname' WHERE id='$cid'";
  ...
  foreach ($_POST['quality'] as $key => $val) {
   ...
   $sql1 = "UPDATE  cutting_inward1 SET cid='$cid',orderno='$orderno',itemno='$itemno',ref='$ref',quality='$quality',color='$color',pcs='$pcs',mtrs='$mtrs',descr='$descr',bundle='$bundle',width='$width',bale='$bale',reqqty='$reqqty' WHERE id='$rid'";
  ...
  echo "<script>alert('Cutting Inward Updated Successfully');window.location='cutting_inward_list.php';</script>";
