...
<title>Fabric Stock Inward Print</title>
<style>
table {
...
<table align="center" width="852" style="border:none; page-break-before:always;">
 ...
 $wz=mysqli_query($conn,"select * from fabric_stock_inward  where id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['refno'];
$date=$wz1['date'];
$dcno=$wz1['dcno'];
...
<div style="margin-left:15%;margin-top:2%">
        <?php  
          $a0="SELECT * FROM fabric_stock_inward e left join partymaster a on e.partyname=a.id  where e.id='$sid'";
//echo $a0;
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  ...
  <?php
		   ...
		   $sno=1;$i=0;$j=0;
$sql = "SELECT *,j.descr as descr,l.color as color,j.width as width,k.quality as quality  FROM fabric_stock_inward1 j  left join quality_master k on j.quality=k.id left join color l on j.color=l.id   where j.cid='$sid' order by j.id asc";
//echo $sql;
...
{	  
 ...
 <td  style="border-left:2px solid black;" colspan="5" ><div align="right"><strong>Total&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div></td>
