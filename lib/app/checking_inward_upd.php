        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM checking_inward WHERE id='$sid'";
                    ...
                    <?php } ?>
                        ...
                        <table class="table table-border border-top table-hover">
                              ...
                              <?php
                                  $sno=1; $i=0;
                              $sql4 = " SELECT * FROM checking_inward1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
...
<?php $sno++; $i++;
            ...
            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-dark btn-prev" href="checkinginlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE checking_inward SET dcno='$dcno',refno='$refno',fromvalue='$fromvalue',date='$date',partyname='$partyname',vehicleno='$vehicleno',
 dvrname='$dvrname' WHERE id='$cid'";
  ...
  foreach ($_POST['pcs'] as $key => $val) {
   ...
   $sql1 = "UPDATE  checking_inward1 SET cid='$cid',ref='$ref',orderno='$orderno',itemno='$itemno',quality='$quality',color='$color',pcs='$pcs',descr='$descr' WHERE id='$rid'";
 ...
 echo "<script>alert('Checking Inward Updated Successfully');window.location='checkinginlist.php';</script>";
