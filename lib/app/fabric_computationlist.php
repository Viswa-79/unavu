          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">FABRIC COMPUATION LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="fabric_computation.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                    <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT * FROM fabric_computation ORDER by id desc" ;
                     ...
                     <td><?php echo $rows['orderno'];?></td>                          
                          ...
                          <td nowrap>
                            <a href="fabric_computation_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <a href="fabric_computation_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          <?php if($user_role==2){ ?>
                            <a  href="ajax/delfabric_computation.php?cid=<?php echo base64_encode($rows['id']);?>"
                             type="button" data-bs-toggle="offcanvas"
                          data-bs-target="#offcanvasEcommerceCustomer"style="width:113px" 
                          class="btn btn-outline-danger"
                          id="del<?php echo $sno;?>" 
                          onclick="delfabric_computation(del<?php echo $sno;?>.id);" >
...
<script>
function delfabric_computation(id) {
...
if(data.sts == 'ok'){
  ...
  window.location='fabric_computationlist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delfabric_computation.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
