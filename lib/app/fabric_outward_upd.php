        ...
        <div class="layout-page">
		 ...
		 ?>               
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <!-- Personal Info -->
                        <?php
                              $sql4 = " SELECT * FROM fabric_outward WHERE id='$sid'";
                    ...
                    <?php } ?>
                        ...
                        <table class="table table-border border-top table-hover">
                              ...
                              <?php
                                  $sno=1; $i=0;
                              $sql4 = " SELECT * FROM fabric_outward1 Where cid='$sid' order by id asc";
                              $result4 = mysqli_query($conn, $sql4);
...
<?php $sno++; $i++;
            ...
            <div class="col-12 d-flex justify-content-between">
                              <a class="btn btn-label-secondary btn-prev" href="faboutlist.php">
...
if (isset($_POST['submit'])) {
  ...
  $sql = "UPDATE fabric_outward SET dcno='$dcno',refno='$refno',date='$date',partyname='$partyname',vehicleno='$vehicleno',
 dvrname='$dvrname' WHERE id='$cid'";
  ...
  foreach ($_POST['quality'] as $key => $val) {
   ...
   $sql1 = "UPDATE  fabric_outward1 SET cid='$cid',orderno='$orderno',itemno='$itemno',quality='$quality',color='$color',pcs='$pcs',mtrs='$mtrs',descr='$descr',bundle='$bundle',stockloc='$stockloc',width='$width',bale='$bale',ref='$ref',reqqty='$reqqty'  WHERE id='$rid'";
  ...
  echo "<script>alert('Fabric Updated Successfully');window.location='faboutlist.php';</script>";
