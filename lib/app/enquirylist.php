          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">ENQUIRY&nbsp;LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="enquiry.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                    ...
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM enquiry e left join partymaster p on e.partyname=p.id ORDER by e.id desc" ;
