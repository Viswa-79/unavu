          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">Time&nbsp;&&nbsp;Action</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="action_form.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                  ...
                  <div class="card-datatable table-responsive">
                     <table id="myTable" class="table table-hover display">
                      ...
                      <?php
                         ...
                         $sql = " SELECT * FROM action_form ORDER by id desc" ;
                     ...
                     <td><?php echo $rows['orderno'];?></td>                          
                          ...
                          <td nowrap>
                          <a href="action_form_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          ...
                          type="button" style="width:113px" class="btn btn-outline-warning" id="edit<?php echo $sno;?>">
                            ...
                            <a  href="ajax/delaction_form.php?cid=<?php echo base64_encode($rows['id']);?>"
...
if(data.sts == 'ok'){
  ...
  window.location='action_formlist.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delaction_form.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
