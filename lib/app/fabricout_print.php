...
<title>Fabric Outward Print</title>
<style>
table {
...
<table align="center" width="852" style="border:none; page-break-before:always;">
  ...
  <tr style="border:none;">
    <td  width="709" height="25" style="border:none;"><div style="margin-left:40%"><strong style="font-size:22px;">FABRIC OUTWARD</strong></div></td>
  </tr>
</table>
 ...
 $wz=mysqli_query($conn,"select * from fabric_outward  where id='$sid'");
$wz1=mysqli_fetch_array($wz);
$refno=$wz1['refno'];
$date=$wz1['date'];
$dcno=$wz1['dcno'];
...
<table width="850" style="border: 1px solid black;border-collapse: collapse;border-color:#999;"  align="center">
 ...
 <strong>Email : <?php echo $rz2['emailid'];?></strong>
  ...
  <tr style="border: 1px solid black;border-collapse: collapse;border-color:#999;">
    <td height="50" colspan="2" rowspan="2" style="border: 1px solid black;border-collapse: collapse;border-color:#999; border-left: 2px solid black;border-collapse: collapse; border-top: 1px solid #999;border-bottom: 1px solid #999;border-collapse: collapse; vertical-align:text-top;" >
<div style="margin-left:15%;margin-top:2%">
        <?php  
           $a0="SELECT * FROM fabric_outward e left join partymaster a on e.partyname=a.id  where e.id='$sid'";
//echo $a0;
...
<table  width="850"  align="center" style="border: 1.5px solid black;border-collapse: collapse;">
  <tr align="center" style="font-weight:bold;border-collapse: collapse;background-color:#<?php echo $color;?>;color:#<?php echo $font_color;?>;">
    <td style="border-left: 2px solid black;border-top: 2px solid black;border-collapse: collapse;border-right:  1px solid black;border-bottom: 2px solid blac;border-collapse: collapse; "  height="35">S.No</td>
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse; border-right:  1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999;">Ref</td>
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse; border-right:  1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999;">Order No</td>
    <td  style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right:  1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Item N0</td>
   
    <td style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right:  1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Quality</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Width</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Color</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Bale No's</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Bales</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 1px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Pieces</td>
  <td   style="border: 1px solid black;border-top: 2px solid black;border-collapse: collapse;border-right: 2px solid black;border-bottom: 2px solid black;border-left: 1px solid #999; ">Meters</td>
  ...
  <?php
		   ...
		   $sno=1;$i=0;$j=0;
$sql = "SELECT *,j.descr as descr,l.color as color,j.width as width,k.quality as quality  FROM fabric_outward1 j  left join quality_master k on j.quality=k.id left join color l on j.color=l.id  left join item_master z on j.itemno=z.id where j.cid='$sid' order by j.id asc";
$result = mysqli_query($conn,$sql);
while($row = mysqli_fetch_array($result))
{
	?>
  <tr style="border-bottom:none;border-collapse: collapse;font-size:12px; margin-top:4px;">
   ...
   border-right: 1px solid #999;"><div align="center"><?php echo $sno;?> </div></td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['ref']; ?></td>
    <td height="" align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse; padding-left:5px;"><?php echo $row['orderno'];?> </td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['code']; ?></td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['quality']; ?></td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['width']; ?></td>
    <td height=""  align="center" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['color']; ?></td>
    <td height=""  align="left" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['bale']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['bundle']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 1px solid #999;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['pcs']; ?></td>
    <td height=""  align="right" style="border-top:none;border-bottom:none;border-right: 2px solid black;border-left: 1px solid #999; border-collapse: collapse;padding-right:5px;"><?php echo $row['mtrs']; ?></td>
  </tr>
  <?php
	
  $tlbundle+=number_format((float)$row['bundle'], 2, '.', '');
	$tlpcs+=number_format((float)$row['pcs'], 2, '.', '');
  $tomtrs+=number_format((float)$row['mtrs'], 2, '.', '');
...
{	  
 ...
 <td  style="border-left:2px solid black;" colspan="8" ><div align="right"><strong>Total&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $tlbundle; ?></strong></div></td>

<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $tlpcs; ?></strong></div></td>
<td  style="border-right:2px solid black;" ><div align="right"><strong><?php echo $tomtrs; ?></strong></div></td>
</tr>
</table>
