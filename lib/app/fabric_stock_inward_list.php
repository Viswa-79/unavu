<?php include "config.php"; ?>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">FABRIC STOCK INWARD LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="fabric_stock_inward.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
 ...
 <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM fabric_stock_inward e left join partymaster p on e.partyname=p.id ORDER by e.id desc" ;
                  ...
                  $sql2 = "SELECT * FROM fabric_stock_inward1 where cid='$cid' order by orderno asc" ;
                    ...
                    <input type="text" hidden name="cid[]" id="cid<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                     ...
                     <td><?php echo $rows['name'];?></td>                          
                          ...
                          <td nowrap>
                            <a href="fabric_stock_inward_print.php?cid=<?php echo base64_encode($rows['id']);?>" 
                            type="button" class="btn btn-outline-warning" id="<?php echo $sno;?>">
                              <span class="ti-xs ti ti-printer me-1"></span>Print
                            </a>
                      
                          <a href="fabric_stock_inward_upd.php?cid=<?php echo base64_encode($rows['id']);?>" 
                          type="button" class="btn btn-outline-primary" id="edit<?php echo $sno;?>">
                            <span class="ti-xs ti ti-edit me-1"></span>View/Edit
                          </a>
                          
                          <?php if($user_role==2){ ?>
                            <a  href="ajax/delfabric_stock_inward.php?cid=<?php echo base64_encode($rows['id']);?>"
...
if(data.sts == 'ok'){
  ...
  window.location='fabric_stock_inward_list.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delfabricstockin.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
