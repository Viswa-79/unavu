...
<?php
$fg1="select max(dcno) as id from checking_inward";
		   //echo $fg1;
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-primary">Checking Inward</button>
                      <a href="checkinginlist.php"
                        ...
                        <div class="row g-3 mb-6">
                          ...
                          <div class="col-md-2">
                            ...
                            <input
                              ...
                              id="refno"
                              name="refno"
                              onblur="get_packdetails(this.value)"
                            onchange="get_dcdetails(this.value);"
...
if (isset($_POST['submit'])) {
  ...
  $dvrname = $_POST['dvrname'];
    ...
    $sql = "INSERT into checking_inward (dcno,refno,fromvalue,date,partyname,vehicleno,dvrname) values ('$dcno','$refno','$fromvalue','$date','$partyname','$vehicleno','$dvrname')";
    $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['pcs'] as $key => $val) {
    ...
    if ($orderno != '') {
       $sql1 = "INSERT into checking_inward1 (cid,ref,orderno,itemno,quality,color,pcs,descr) 
 values ('$cid','$ref','$orderno','$itemno','$quality','$color','$pcs','$descr')";
  ...
  echo "<script>alert('Checking Inward Registered Successfully');window.location='checking_inward.php';</script>";
...
<script>
function get_packdetails(value) {
//alert(value);
var form='checking_inward';
  if (value!= "") {
...
if(sts==1)
{
  document.getElementById('cutpandcno').innerHTML =r1[1];
            ...
            //   if(sts==2)
            // {
            //   alert("Checking Inward Already Made For This Dc No.!");
    ...
    xmlhttp.open("GET","ajax/get_checkdcno.php?refno="+value+"&q="+form,true);
    xmlhttp.send();
  }
}
</script>
...
$('#partyname').val(data.partyname);
    ...
    xmlhttp.open("GET","ajax/getdcdetails.php?id="+value,true);
    xmlhttp.send();
  }
}
</script>
