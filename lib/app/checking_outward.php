...
<?php
$fg1="select max(dcno) as id from checking_outward";
		   //echo $fg1;
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <form class="card-body" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="row mb-6">
                          ...
                          <div class="col-md-2">
							...
							<?php 
					$sql = "SELECT * FROM partymaster where process='7' order by name asc";
                    ...
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            <label class="form-label" for="collapsible-fullname">Vehicle&nbsp;No</span></label>
                            <input
                              type="text"
                              id="vehicleno"
                              name="vehicleno"
                ...
                <td style="padding: 0.3rem">
                             <select name="itemno[]"   id="itemno<?php echo $i;?>" class="select form-select" onchange="get_quality(this.id,this.value);get_item_details(this.id,this.value);get_cut(this.id,this.value);get_value(this.id,this.value);" >
...
if (isset($_POST['submit'])) {
  ...
  $dvrname = $_POST['dvrname'];
    ...
    $sql = "INSERT into checking_outward (dcno,refno,date,partyname,vehicleno,dvrname) values ('$dcno','$refno','$date','$partyname','$vehicleno','$dvrname')";
    $result = mysqli_query($conn, $sql);
  ...
  foreach ($_POST['pcs'] as $key => $val) {
    ...
    if ($orderno != '') {
       $sql1 = "INSERT into checking_outward1 (cid,orderno,ref,itemno,pcs,totcut,loopwaste,adas,loss,descr) 
 values ('$cid','$orderno','$ref','$itemno','$pcs','$totcut','$loopwaste','$adas','$loss','$descr')";
  ...
  echo "<script>alert('Checking Outward Registered Successfully');window.location='checking_outward.php';</script>";
...
function get_value(id,value) {
  var c=id.substr(6);
  // alert(c);
	var form='checking_inward1';
	var form1='checking_outward1';
	var value2=document.getElementById('orderno'+c).value;		
  if (value != "") {
...
<script> 
  function getexcess(id,value){
    ...
    if(parseFloat(mtrs)>parseFloat(reqqty)){
      alert("Required Quantity Exceeded Order Qty.");
