...
var v=document.getElementById('price'+b).value?document.getElementById('price'+b).value:0;
	...
	document.getElementById('totamt'+b).value=tt;
...
<div class="table-responsive"><br>
                ...
                <td style="padding: 0.3rem">
                 <input style="width:120px"
                                   ...
                                   <td style="padding: 0.3rem">
                                   <select name="itemno[]" style="width:300px" id="itemno<?php echo $i;?>" class="select form-select" onchange="get_qty(this.id,this.value)"  >
                                <option value="">Select</option>
							<?php 
               ...
               <td style="padding: 0.3rem">
                 ...
                 <input
                                    ...
                                    onkeyUp="tott(this.id);"
									onchange="tott(this.id);"
                                    name="quantity[]"
...
if (isset($_POST['submit'])) {
  ...
  $sample = $_POST['sample'];
    ...
    $sql = "INSERT into order1 (ord_no,enq_no,refno,date,partyname,ordertype,length,Destination,payment,tolerance,currency,shipterm,shipment,loads,contact,title,agent,remark,notes,sample) 
 values ('$ord_no','$enq_no','$refno','$date','$partyname','$ordertype','$length','$Destination','$payment','$tolerance','$currency','$shipterm','$shipment','$loads','$contact','$title','$agent','$remark','$notes','$sample')";
    $result = mysqli_query($conn, $sql);
 ...
 values ('$cid','$pono','$itemno','$itemdesc','$label','$print','$quality','$pack','$clwidth','$size','$quantity','$unit','$price','$totamt')";
  ...
  if ($result) {
   ...
   echo "<script>alert('Order Registered successfully');window.location='order_confirm.php';</script>";
