...
<script type="text/javascript" src="http://jqueryjs.googlecode.com/files/jquery-1.3.1.min.js" > </script> 
 ...
 $sid=base64_decode($_GET['cid']);
  $sql = " SELECT * FROM material_resource WHERE id='$sid'";
...
<body>
  ...
  <tr height="100px">
   ...
   <table width="878"  align="center" >
	...
	<strong> <?php echo $status;?></strong>	 </td>
        </tr>
 ...
 <span class="style5"><strong>Ref No.</strong> </span>
</td>
 <td style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['refno'];?> </span>
</td>
 ...
 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['orderno'];?> </span>
</td>
 </tr>
 ...
 <span class="style5"><strong>PONO</strong> </span>
</td>
 <td style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['pono'];?> </span>
</td>
 </tr>
 ...
 <span class="style5"><strong>Order Qty.</strong> </span></td>
 <td width="554" style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['orderqty'];?></span></td>
 ...
 <span class="style5"><strong>Required Qty.</strong> </span></td>
 <td width="554" style="border:none; border-right:none; vertical-align:text-top;" >

 <span class="style5">:&nbsp;&nbsp;&nbsp;<?php echo $so['requiredqty'];?></span></td>
 ...
 <table width="870" align="center" style=" border:1px solid #000000; border-collapse: collapse;font-size:18px;">
    <tr>
      ...
      <td width="161" height="30" style=" border:1px solid #000000; "><div align="center">
        <strong>Particulars</strong>
       
      </div></td>
      <td width="98"  style=" border:1px solid #000000; "><div align="center" ><strong>UOM</strong></div></td>
     
	  <td width="79"  style=" border:1px solid #000000; "><div align="center" ><strong>Required Qty</strong></div></td>
	  <td width="79"  style=" border:1px solid #000000; "><div align="center" ><strong>Excess Qty (%)</strong></div></td>
	  <td width="79"  style=" border:1px solid #000000; "><div align="center" ><strong>Total Qty</strong></div></td>
...
$totreq=0;
$totexcess=0;
    $b1="SELECT * FROM material_resource1 e left join product_master p on e.productname=p.id where cid='$sid' ";
  ...
  <tr style="border-bottom:1px solid black;" >
      ...
      <td height="30" style="border-right:1px solid black;"> <div align="left" style="margin-left:2%;"><strong>
      <?php echo $b3->productname;?>
	 </div></td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->uom;?></br><strong></strong>
     </div></td>

      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->reqqty;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->excess;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;"><?php echo $b3->excessqty;?> </div>      </td>
