...
$i=1;
  ...
  $b1="SELECT * FROM packing_entry1 e left join item_master d on e.itemno=d.id  left join order1  o1 on e.orderno=o1.ord_no left join order2 o2 on o1.id=o2.cid where e.cid='$sid' order by e.id asc";
	...
	?>
<tr>
 <td  colspan="2" style=" border:1px solid #000000; "><div align="left" ><strong>Order No :</strong> <?php echo $so1->orderno;?></div></td>
 <td colspan="3" style=" border:1px solid #000000; "><div align="left" ><strong>Item No :</strong> <?php echo $so1->code;?></div></td>
 <td colspan="3"  style=" border:1px solid #000000; "><div align="left" ><strong>Po No :</strong> <?php echo $so1->pono;?></div></td>
 ...
 <td   style=" border:1px solid #000000; "colspan="7"><div align="left" ><?php echo $so1->itemdesc;?></div></td>

 </tr>
 <tr>
 <td width="80"  style=" border:1px solid #000000; "><div align="left" ><strong>Carton Size :</strong></div></td>
 <td  style=" border:1px solid #000000; "colspan="7"><div align="left" ><?php echo $so1->cartonsize;?><strong></strong></div></td>

 </tr>
<tr>
   
      <td width="145"  style=" border:1px solid #000000; "><div align="center">
        <strong>Carton NOS</strong>
       
      </div></td>
      <td width="98"  style=" border:1px solid #000000; "><div align="center" ><strong>Total Carton</strong></div></td>
      <td width="98"  style=" border:1px solid #000000; "><div align="center" ><strong>Box Pcs</strong></div></td>
  ...
  <tr style="border-bottom:1px solid black;" >
      ...
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->frombox;?>-<?php echo $so1->tobox;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="right" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->totalbox;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->boxpcs;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="right" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->totalpcs;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->netweight;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="center" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo $so1->grossweight;?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="right" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo number_format((float)$so1->totalnet);?> </div>      </td>
      <td  style="border-right:1px solid black;" ><div align="right" style="margin-left:2%;margin-bottom:2%;margin-top:2%;"><?php echo number_format((float)$so1->totalgross);?> </div>      </td>
    ...
    $totbox+=$so1->totalbox;
    $totpcs+=$so1->totalpcs;
    $totnet+=number_format((float)$so1->totalnet, 3, '.', '');
    $totgross+=number_format((float)$so1->totalgross, 3, '.', '');

?> 
    <tr  style="border:none;">
 
	
 <td  style="border-left:1px solid black;border-right:1px solid black;" colspan="1" ><div align="right"><strong>Total&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $totbox;  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $totpcs;  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $totnet;  ?></strong></div></td>
<td  style="border-right:1px solid black;" ><div align="right"><strong><?php echo $totgross;  ?></strong></div></td>
</tr>
 
 
 <tr ><td  style="border:1px solid black;"   colspan="8" >&nbsp;</td></tr>
<?php
  ...
  <br>
<table width="879" align="center" style=" border:1px solid black; border-collapse: collapse;font-size:18px;">
<?php
$tqty=0;
$pcsto=0;
$netto=0;
$grossto=0;
$b1="SELECT sum(totalbox) as totalbox,sum(totalpcs) as totalpcs,sum(totalnet) as totalnet,sum(totalgross) as totalgross  FROM packing_entry1 where cid='$sid'";
$b2=mysqli_query($conn,$b1);
$so1=mysqli_fetch_object($b2);
  
	
    $tqty=number_format((float)$so1->totalbox);
    $pcsto=number_format((float)$so1->totalpcs);
    $netto=number_format((float)$so1->totalnet, 3, '.', '');
    $grossto=number_format((float)$so1->totalgross, 3, '.', '');
 

  ?> 
<tr>
<td  style="border-right:1px solid black;border-left:1px solid black;" ><div align="left"><strong>Total Carton : </strong><?php echo $tqty;echo " "."Cartons";  ?> </div></td>
 </tr>
 <tr>
<td  style="border-right:1px solid black;border-left:1px solid black;" ><div align="left"><strong>Total Pcs : </strong><?php echo $pcsto; echo " "."Pcs"; ?></div></td>
 </tr>
 <tr>
<td  style="border-right:1px solid black;border-left:1px solid black;" ><div align="left"><strong>Total NT.WT : </strong><?php echo $netto;echo " "."Kgs"; ?></div></td>
 </tr>
 <tr>
<td  style="border-right:1px solid black;border-left:1px solid black;" ><div align="left"><strong>Total GR.WT : </strong><?php echo $grossto;echo " "."Kgs"; ?></div></td>
 </tr>
