          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      <button class="btn btn-label-success">PACKING ENTRY LIST</button><br>
                     ...
                     <div >
                            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                              <a type="button" href="packing_entry.php" class="btn btn-primary"> <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i> Add New
                    ...
                    <table id="myTable" class="table table-hover display">
                      ...
                      <tbody>
                        <?php
                         ...
                         $sql = " SELECT *,e.id as id FROM packing_entry e left join partymaster p on e.partyname=p.id ORDER by e.id desc" ;
                       ...
                       while ($rows=mysqli_fetch_array($result))

                         {
                          ...
                          $sql2 = "SELECT * FROM packing_entry1 where cid='$cid' order by orderno asc" ;
...
if(data.sts == 'ok'){
  ...
  window.location='packing_entry_list.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delpacking_entry.php?id="+cid,true);
    xmlhttp.send();
  }
}
}
