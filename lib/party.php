...
<html
  ...
  <head>
    ...
    <meta
     ...
     <title>Order Entry Truezor Soft</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="hover:rotate-[360deg]">
                <a href="/">
                <img
                  
                  src="../../assets/img/favicon/dd.png"
                  alt="logo"
                     width="40px"
                     height="40px"
                     align-item="left"
              ...
              <span class="app-brand-text demo menu-text fw-bold">&nbsp;&nbsp;TRUEZOR</span>
            </a>
                    ...
                    <div class="bs-stepper-content">
                      <form onSubmit="return false">
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col">
                            <label class="form-label" for="ecommerce-product-barcode">Group</label>
                            <select id="formtabs-country" class="select2 form-select" data-allow-clear="true">
                              ...
                              <select id="formtabs-country7" class="select2 form-select" data-allow-clear="true">
                                <option value="">Select</option>
                                <option value="aop">AOP </option>
                                <option value="compacting">Compacting</option>
                                <option value="dyeing">Dyeing </option>
                                <option value="heatsetting">Heat Setting </option>
                                <option value="knitting">knitting </option>
                                <option value="lycraknitting">Lycra knitting </option>
                                <option value="raising">Raising </option>
                                <option value="stenetring">Stenetring </option>
                          ...
                          <div class="col">
                              <label class="form-label" for="formtabs-country">Party Name</label>
                              <input
                              type="text"
                              class="form-control"
                          ...
                          <div class="col">
                            <label class="form-label" for="ecommerce-product-barcode">Mobile No.: </label>
                            <input
                              type="text"
                              class="form-control"
                              id="ecommerce-product-barcode"
                            ...
                            <label class="form-label" for="ecommerce-product-barcode">Email ID</label>
                            <input
                          type="email"
                          class="form-control"
                        ...
                        <div class="row mb-3">
                              ...
                              <div class="col">
                            <label class="form-label" for="ecommerce-product-barcode">Address</label>
                            <input
                              type="text"
                              class="form-control"
                              id="ecommerce-product-barcode"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col">
                            <label class="form-label" for="ecommerce-product-barcode">Country</label>
                            <input
                          type="text"
                          class="form-control"
                          id="exampleFormControlInput1"
                          ...
                          <div class="col">
                            <label class="form-label" for="ecommerce-product-barcode">Pincode </label>
                            <input
                              type="text"
                              class="form-control"
                              id="ecommerce-product-barcode"
                          ...
                          <div class="col">
                            ...
                            <div class="table-responsive">
                             ...
                             <div class="col-12 d-flex justify-content-between">
                              <button class="btn btn-label-secondary btn-view">
                                <i class="ti ti-arrow-left me-sm-1 me-0"></i>
                                <span class="align-middle d-sm-inline-block d-none">View</span>
                              </button>
                        ...
                        <div id="ordersum" class="content">
                          ...
                          <div class="row mb-3">
                              <div class="col">
                              <label class="form-label" for="formtabs-country">Order Date</label>
                              <input type="date" id="bs-datepicker-format" placeholder="DD/MM/YYYY" class="form-control" />
                            </div>
                               <div class="col">
