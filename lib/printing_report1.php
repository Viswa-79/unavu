            ...
            <div  class="container-xxl flex-grow-1 container-p-y">
              <div id="mydiv" class="card mb-4 ">
                ...
                <tbody>
                   <?php 
                 $sno=1;
                 $sql4 = " SELECT *,s.id as idn FROM printing s left join printing1 s1 on s.id=s1.cid left join item_master c on s1.itemno=c.id where date between '$fromdate' and '$todate' order by book asc";
               ...
               <td><a href="printing_upd.php?cid=<?php echo base64_encode($id);?>" target="blank" ><?php echo $wz1['book']; ?></a></td>      
...
<a href="printing_report.php" class="btn btn-primary mt-4"><i class="ti ti-arrow-left me-sm-1 me-0"></i>Back</a>&nbsp;&nbsp;
