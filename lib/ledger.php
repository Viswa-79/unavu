          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card-header d-flex align-items-center justify-content-between">
                      ...
                      <button class="btn btn-label-primary">Processing Ledger Report </button>
                     
                    </div>  <br>         
                                <div class="card mb-2 mt-2">
                   
                      <form class="card-body" action="ledger1.php" method="post" enctype="multipart/form-data">
                    ...
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            ...
                            <select name="orderno" id="orderno" class="select form-select" onchange="get_items2(this.value);" >
                                <option value="">Select</option>
							<?php 
                    ...
                    <?php } ?>
                          ...
                          <div class="col-md-2">
                            <label class="form-label" for="collapsible-fullname">Quality</label>
