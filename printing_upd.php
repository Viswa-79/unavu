...
if (isset($_POST['submit'])) {
  ...
  if ($deliverydt != '') {
    $sql = "UPDATE printing SET book='$book',date='$date',deliverydt='$deliverydt',checking='$checking',reorder='$reorder',orderno='$orderno',to1='$to1',flref='$flref',instruction='$instruction',remarks='$remarks' ,label='$p1',label1='$p2' where id='$cid'";
    $result = mysqli_query($conn, $sql);
  }
