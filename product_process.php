            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
               <div 
                      ...
                      <h5 class="card-title mb-sm-0 me-2" >PROCESS LIST</h5>
               ...
               &nbsp;   <button class="btn btn-secondary add-new btn-primary" tabindex="0" onclick="addProcess();" aria-controls="DataTables_Table_0"
                 type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAddUser"><span>
                  <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                <span class="d-none d-sm-inline-block">Add New Process</span></span></button>
                      </div>
                    </div>
                  ...
                  ?>
                     <input type="text" hidden name="id[]" id="id<?php echo $sno; ?>" value="<?php echo $rows['id'];?>">
                      ...
                      <td><?php echo $rows['sub'];?></td>
                          ...
                          id="edit<?php echo $sno;?>" onclick="getProcess(edit<?php echo $sno;?>.id);" 
                         >
                          ...
                          id="del<?php echo $sno;?>" onclick="delProcess(del<?php echo $sno;?>.id);" >
               ...
               <tr><td colspan="5" align="center">  <p>No Data Found</p></td> </tr>
                ...
                <div
                  ...
                  <div class="offcanvas-header">
                    <h5 id="offcanvasAddUserLabel" class="offcanvas-title"><span id="form-title">Add</span> Process</h5>
                    <button
                      type="button"
                  ...
                  <div class="offcanvas-body mx-0 flex-grow-0 pt-0 h-100">
                    <form action="" method="post">
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Process</label>
                        <input
                          type="text"
                          class="form-control"
                          id="process"
                      ...
                      <div class="mb-3">
                      <label class="form-label" for="add-user-fullname">Sub Process</label>
                        <input
                          type="text"
                          class="form-control"
                          id="sub"
...
if($id==""){
 ...
 $sql="insert into process (process,sub) values('$process','$sub')";
 $result1=mysqli_query($conn, $sql);
 
}else{
  $sql="UPDATE process SET process='$process',sub='$sub' WHERE id='$id'"; 
  $result2=mysqli_query($conn, $sql);
}
if($result1) { 
 
  echo "<script>alert('Process Registered successfully');window.location='product_process.php';</script>";
 
}
else if($result2) { 
  echo "<script>alert('Process Updated Successfully');window.location='product_process.php';</script>";
...
if(data.sts == 'ok'){
    ...
    xmlhttp.open("GET","ajax/getProcess.php?id="+user_id,true);
    xmlhttp.send();
  }
}
</script>
...
if(data.sts == 'ok'){
  ...
  window.location='product_process.php';

                   
}
      }
    };
    xmlhttp.open("GET","ajax/delProcess.php?id="+user_id,true);
    xmlhttp.send();
  }
}
}
